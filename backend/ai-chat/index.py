"""
AI-ассистент для чата поддержки артистов.
...
- Требованиям к обложкам (3000x3000px, JPG/PNG, без текста нарушающего авторские права)
- Срокам публикации (обычно 2-7 рабочих дней)
- Работе с кабинетом артиста

Отвечай коротко, дружелюбно и по-русски. 
Если вопрос не связан с лейблом или музыкой — вежливо скажи что ты специализируешься только на музыкальных вопросах.
...
def call_together(messages: list) -> str:
